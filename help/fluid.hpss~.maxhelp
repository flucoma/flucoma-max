...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "The audio input\nThe harmonic part extracted,\nThe percussive part extracted, \nThe rest. \nThe latency between the input and the output is ((harmFiltSize + (windowsize / hopSize) - 1) * hopSize) samples."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 868.0, 1148.0, 100.0 ],
					"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 103.0, 387.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 103.0, 429.0, 86.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 208.5, 150.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 137.0, 150.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 256.5, 122.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 180.0, 432.0, 86.0, 22.0 ],
									"style" : "",
									"text" : "getattr latency"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 777.5, 602.5, 63.0, 22.0 ],
									"style" : "",
									"text" : "pack f f f f"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 782.0, 566.0, 99.0, 22.0 ],
									"style" : "",
									"text" : "expr $f1 / $f2 * 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 778.0, 528.0, 99.0, 22.0 ],
									"style" : "",
									"text" : "expr $f1 / $f2 * 2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 854.0, 504.0, 63.0, 22.0 ],
									"style" : "",
									"text" : "dspstate~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 906.5, 472.067627, 81.0, 22.0 ],
									"style" : "",
									"text" : "0."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 872.5, 472.067627, 25.0, 20.0 ],
									"style" : "",
									"text" : "dB"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1230.0, 633.5, 227.0, 20.0 ],
									"style" : "",
