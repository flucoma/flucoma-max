...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 169.0, 209.0, 22.0 ],
					"text" : "fluid.bufferinterface fluid.bufnmfseed~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 231.0, 260.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 291.0, 401.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "2",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 399.0, 237.0, 25.0 ],
									"text" : "Resynthesise using computed bases"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 20.0, 550.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 410.0, 404.0, 97.0, 23.0 ],
									"text" : "components $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 20.0, 400.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 20.0, 147.0, 50.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 20.0, 192.0, 116.0, 23.0 ],
									"text" : "coverage $1, bang"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 128.0, 340.0, 50.0, 23.0 ]
								}
...
, 															{
																"box" : 																{
																	...
																	"patching_rect" : [ 133.449341000000004, 130.0, 137.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 354.5, 148.5, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "1",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 70.0, 146.0, 281.0, 25.0 ],
									"text" : "Set a coverage amount to trigger processing"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 20.0, 300.0, 127.0, 23.0 ],
									"text" : "info~ help.svd.bases"
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 137.5, 383.0, 419.5, 383.0 ],
									"source" : [ "obj-29", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-20", 0 ],
									"midpoints" : [ 419.5, 447.0, 29.5, 447.0 ],
									"source" : [ "obj-46", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 10.0, 389.0, 57.599853515625 ]
				}
...
,
					"patching_rect" : [ 359.0, 231.0, 50.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
