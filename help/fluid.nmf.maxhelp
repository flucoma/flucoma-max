...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 335.449341, 651.5, 31.0, 22.0 ],
					"style" : "",
					"text" : "/~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 294.449341, 689.0, 97.0, 20.0 ],
					"style" : "",
					"text" : "Not yet nulling..."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 294.449341, 616.0, 25.0, 65.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 371.449341, 493.0, 24.0, 22.0 ],
									"style" : "",
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 371.449341, 467.5, 63.0, 22.0 ],
									"style" : "",
									"text" : "dspstate~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 371.449341, 597.0, 121.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 371.449341, 521.0, 83.0, 22.0 ],
									"style" : "",
									"text" : "getattr samps"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 371.449341, 630.0, 54.0, 22.0 ],
									"style" : "",
									"text" : "phasor~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 403.449341, 555.0, 74.0, 22.0 ],
									"style" : "",
									"text" : "buffer~ jong"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 371.449341, 712.0, 30.0, 30.0 ],
									"style" : "",
									"varname" : "u415000522"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 294.449341, 553.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "delay~ 256 256"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 101.0, 791.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					"fontsize" : 16.0,
					"id" : "obj-40",
					"items" : [ "off", ",", "resynthesis", ",", "vocoder" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 110.0, 686.0, 100.0, 26.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 110.0, 746.0, 391.0, 22.0 ],
					"style" : "",
					"text" : "selector~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 394.0, 631.0, 154.0, 35.0 ],
					"style" : "",
					"text" : "poly~ fluid.nmf.polyplay 5 @target 0 @args resynth"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 1011.79425, 72.5, 113.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "sources 5 jong resynth 8192 1024 256"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 625.449341, 631.0, 196.0, 22.0 ],
					"style" : "",
					"text" : "pfft~ fluid.nmf.noiseplay.pfft 2048 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.0, 196.0, 263.0, 26.0 ],
					"style" : "",
					"text" : "filters 5 jong dict act 2048 1024 256"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 58.0, 269.5, 81.0, 26.0 ],
					"style" : "",
					"text" : "fluid.nmf~"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 403.5, 734.5, 305.5, 734.5 ],
					"order" : 1,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 481.949341, 624.5, 538.5, 624.5 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 344.949341, 667.0, 324.97467, 667.0, 324.97467, 584.0, 314.449341, 584.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 634.949341, 731.5, 491.5, 731.5 ],
					"source" : [ "obj-9", 0 ]
				}
		...
		"dependency_cache" : [ 			{
				"name" : "fluid.nmf.noiseplay.pfft.maxpat",
				"bootpath" : "~/max-devkit/help",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "fluid.nmf.polyplay.maxpat",
				"bootpath" : "~/max-devkit/help",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
