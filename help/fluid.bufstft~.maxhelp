...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 160.0, 193.0, 23.0 ],
					"text" : "fluid.bufferinterface fluid.bufstft~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 310.0, 102.5, 124.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 436.0, 105.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "1",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 356.0, 270.0, 285.0, 25.0 ],
									"text" : "Resynthesise using the reversed magnitudes"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 643.0, 272.5, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "4",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 20.0, 270.0, 49.0, 23.0 ],
									"text" : "t b b"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 242.0, 184.0, 150.0, 60.0 ],
													"text" : "This resizes the buffer~ where the modified magnitudes will be stored and sets the samplerate."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 3,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 24.0, 76.0, 81.0, 22.0 ],
													"text" : "getattr samps"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 24.0, 180.0, 173.0, 22.0 ],
													"text" : "clear, samps $1 513, sr 86.132"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 24.0, 220.0, 205.0, 22.0 ],
													"text" : "buffer~ help.stft.magnitudes.modified"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "float", "bang" ],
													"patching_rect" : [ 244.0, 110.0, 143.0, 22.0 ],
													"text" : "buffer~ help.stft.phases.2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "float", "bang" ],
													"patching_rect" : [ 55.0, 110.0, 167.0, 22.0 ],
													"text" : "buffer~ help.stft.magnitudes.2"
												}
...
,
									"patching_rect" : [ 50.0, 310.0, 223.0, 23.0 ],
...
,
									"text" : "p \"resize modified magnitudes buffer\""
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "list" ],
													"patching_rect" : [ 17.0, 241.0, 60.0, 22.0 ],
													"text" : "listfunnel"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 215.0, 201.0, 29.5, 22.0 ],
													"text" : "+ 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 17.0, 281.0, 217.0, 22.0 ],
													"text" : "peek~ help.stft.magnitudes.modified"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 76.0, 111.0, 80.0, 22.0 ],
													"text" : "startchan $1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "int" ],
													"patching_rect" : [ 17.0, 71.0, 78.0, 22.0 ],
													"text" : "t b i"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 17.0, 201.0, 153.0, 22.0 ],
													"text" : "zl.rev @zlmaxsize 32768"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "list" ],
													"patching_rect" : [ 17.0, 161.0, 304.0, 22.0 ],
													"text" : "fluid.buf2list 30000 @source help.stft.magnitudes.2"
												}
...
, 											{
												"patchline" : 												{
													...
													"midpoints" : [ 85.5, 95.0, 331.0, 95.0, 331.0, 197.0, 224.5, 197.0 ],
													"order" : 0,
													"source" : [ "obj-28", 1 ]
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-11", 0 ],
													"midpoints" : [ 85.5, 148.0, 26.5, 148.0 ],
													"source" : [ "obj-31", 0 ]
												}
...
,
									"patching_rect" : [ 62.0, 400.0, 143.0, 23.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 41.0, 440.0, 59.0, 23.0 ],
									"text" : "sr 44100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 41.0, 480.0, 155.0, 23.0 ],
									"text" : "buffer~ help.stft.resynth.2"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 20.0, 360.0, 61.0, 23.0 ],
									"text" : "uzi 513 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 330.0, 311.5, 400.0, 38.0 ],
									"text" : "fluid.bufstft~ @inverse 1 @resynth help.stft.resynth.2 @magnitude help.stft.magnitudes.modified @phase help.stft.phases.2"
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "" ],
									"patching_rect" : [ 20.0, 100.0, 288.0, 30.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 46.0, 180.0, 129.0, 25.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 177.0, 182.5, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "2",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "" ],
									"patching_rect" : [ 20.0, 223.0, 582.0, 23.0 ],
									"text" : "fluid.bufstft~ @source help.stft.src.2 @magnitude help.stft.magnitudes.2 @phase help.stft.phases.2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 20.0, 140.0, 130.0, 23.0 ],
									"text" : "buffer~ help.stft.src.2"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 29.5, 205.0, 29.5, 205.0 ],
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-11", 0 ],
									"midpoints" : [ 50.5, 431.0, 24.5, 431.0 ],
									"order" : 1,
									"source" : [ "obj-13", 1 ]
								}
...
,
					"patching_rect" : [ 70.0, 120.0, 125.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 220.0, 190.0, 249.0, 23.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 160.0, 166.432372999999984, 109.0, 40.0 ],
									"text" : "Choose a source"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 270.0, 183.432372999999984, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "1",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 6.0, 4.0, 93.0, 23.0 ],
													"text" : "loadmess path"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 130.5, 167.833344000000011, 102.0, 23.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 73.5, 113.833343999999997, 92.0, 23.0 ],
													"text" : "prepend prefix"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 73.5, 85.833343999999997, 133.0, 23.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 6.0, 32.0, 72.0, 23.0 ],
...
,
					"patching_rect" : [ 10.0, 80.0, 50.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
