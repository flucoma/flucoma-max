...
,
		"rect" : [ 400.0, -1086.0, 1212.0, 990.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "A description of the perceived amplitude of the signal"
				}
...
,
						"rect" : [ 400.0, -1060.0, 1212.0, 964.0 ],
						"bglocked" : 0,
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 300.0, 622.0, 35.0, 22.0 ],
									"style" : "",
									"text" : "-313"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 268.333374, 709.5, 0.0, 0.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 270.333344, 661.0, 40.0, 22.0 ],
									"style" : "",
									"text" : "peak"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 834.0, 385.5, 173.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 864.333374, 567.5, 87.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 864.333374, 538.5, 87.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 764.333374, 385.5, 66.0, 22.0 ],
									"style" : "",
									"text" : "zl change"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 764.333374, 474.0, 67.0, 23.0 ],
									"style" : "",
									"text" : "unpack f f"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 952.333374, 539.5, 73.0, 50.0 ],
									"style" : "",
									"text" : "loudness\n\npeak"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "list", "" ],
									"patching_rect" : [ 781.333374, 300.0, 331.0, 23.0 ],
									"style" : "",
									"text" : "fluid.loudness~ 17640 @winsize 17640 @hopsize 4410"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 643.0, 79.0, 150.0, 20.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 613.5, 79.0, 20.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 600.5, 114.0, 182.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 706.0, 185.0, 173.0, 23.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 682.0, 152.0, 92.0, 23.0 ],
									"style" : "",
									"text" : "prepend open"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 682.0, 222.0, 52.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 682.0, 289.0, 45.0, 45.0 ],
									"style" : ""
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 821.833374, 564.25, 873.833374, 564.25 ],
									"source" : [ "obj-14", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"midpoints" : [ 773.833374, 535.25, 873.833374, 535.25 ],
									"source" : [ "obj-14", 0 ]
								}
