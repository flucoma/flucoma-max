...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "float" ],
																	"patching_rect" : [ 170.0, 157.0, 148.0, 22.0 ],
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "float" ],
																	"patching_rect" : [ 20.0, 157.0, 148.0, 22.0 ],
																	"text" : "peek~ kdtree.help.slices"
																}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 67.0, 308.0, 54.0, 22.0 ],
													"text" : "deferlow"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "float", "bang" ],
													"patching_rect" : [ 343.0, 481.0, 291.0, 22.0 ],
													"text" : "buffer~ kdtree.help.slices flucoma_corpus_slices.wav"
												}
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 16.0, 169.0, 54.0, 22.0 ],
																	"text" : "deferlow"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 3,
																	"outlettype" : [ "size", "", "" ],
																	"patching_rect" : [ 16.0, 131.0, 322.0, 22.0 ],
																	"text" : "t size l l"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 73.0, 169.0, 219.0, 22.0 ],
...
, 															{
																"patchline" : 																{
																	"destination" : [ "obj-29", 0 ],
																	"midpoints" : [ 328.5, 420.0, 151.5, 420.0 ],
																	"source" : [ "obj-30", 2 ]
																}
...
, 															{
																"patchline" : 																{
																	"destination" : [ "obj-7", 0 ],
																	"midpoints" : [ 177.0, 160.5, 82.5, 160.5 ],
																	"source" : [ "obj-30", 1 ]
																}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 67.0, 269.875, 55.0, 22.0 ],
													"text" : "t dump b"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 123.0, 308.0, 146.0, 22.0 ],
													"text" : "read flucoma_corpus.json"
												}
