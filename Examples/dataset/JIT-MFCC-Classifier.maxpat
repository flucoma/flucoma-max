...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 803.0, 766.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "sn+hh"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 747.0, 766.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "bd+hh"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 694.5, 766.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "bd+sn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1174.0, 988.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1139.0, 992.0, 20.0, 20.0 ],
					"presentation_rect" : [ 828.0, 776.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"style" : "",
					"text" : "5",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 900.5, 825.0, 109.0, 22.0 ],
					"style" : "",
					"text" : "index JIT-classifier"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 657.5, 766.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "hh"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 626.0, 766.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "sn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 593.0, 766.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "bd"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 372.0, 813.0, 194.0, 22.0 ],
					"style" : "",
					"text" : "sprintf addPointLabel %d entry %s"
				}
...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "fluid.bufmfcc~ 13 @source input @features mfccs @numframes 512 @fftsettings 128"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 807.0, 565.0, 20.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 768.0, 565.0, 20.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 841.0, 565.0, 20.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 688.0, 565.0, 20.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 488.5, 419.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "change~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 488.5, 395.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "delay~ 128 128"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 212.0, 344.5, 409.0, 22.0 ],
					"style" : "",
					"text" : "fluid.ampslice~ @absrampdown 441 @absthreshon -55 @absthreshoff -60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.0, 610.0, 150.0, 22.0 ],
					"style" : ""
				}
