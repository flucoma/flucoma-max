...
public:
  static void classInit(t_class* c, t_symbol* nameSpace, const char* classname)
  {
    ...
    makeAttributes<client::HPSSClient,HPSS_NRT>(c,true);
  }
...
{
  fluid::wrapper::HPSS_NRT::makeClass<fluid::wrapper::HPSS_NRT>(CLASS_BOX, "fluid.bufhpss~");
}
